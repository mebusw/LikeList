 ...
 * <script language=javascript src='js/calendar.js'></script>
 * 
 * <INPUT id="Text1" onclick='popUpCalendar(this, this, " MM/dd/yyyy")' readOnly
 * type="text" size="11" name="Text1">
 * 
 * 
 * 
 */
...

{
    ...
    var fixedX = -1; // x position (-1 if to appear below
    // control)
    var fixedY = -1; // y position (-1 if to appear below
    // control)
    var startAt = 1; // 0 - sunday ; 1 - monday
    var showWeekNumber = 1; // 0 - don't show; 1 - show
    var cnsJsIeFirefoxCalendarShowToday = 1; // 0 - don't show; 1
    // - show
    ...
    var selectDateMessage = "选择[date]日期"; // do not replace [date], it
 ...
 */
...

    {
        ...
        // y = year + 4800 - a
        // m = month + 12a - 3
        // J = day + (153m + 2) / 5 + 365y + y / 4 - y / 100 + y / 400 -
        // 32045
