...
<%@ page import="org.likelist.po.EsjOrderInfo"%>
...
<%
	...
	int out_trade_no = AttrParser.getParaInt(request, "out_trade_no");//ESJ订单号
	String body = "";
	if(request.getParameter("body") != null){
		body = new String(request.getParameter("body"));//商品描述、订单备注、描述
	}
